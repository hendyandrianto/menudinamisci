    ...
    <div data-scrollbar="true" data-height="100%">
        <ul class="nav">
            <li class="nav-profile">
                <div class="image1" style="text-align:center">
                    <a class="fancybox" href="<?php echo base_url();?>assets/img/user1.jpg" style="width:80px;text-align:center;height:102px;" data-fancybox-group="gallery" title="<?php echo $this->session->userdata('nama');?>"><img src="<?php echo base_url();?>assets/img/user1.jpg" style="width:71px;" alt="" /></a>
                </div>
        ...
        <ul class="nav">
            ...
            if($this->session->userdata('level')=='0'){
                ...
                $menusub = $this->db->query("SELECT * FROM tbl_submenu WHERE sstatus='1' ORDER BY smenu_id")->result();
                ...
                $menusubx = $this->db->query("SELECT * FROM tbl_submenux WHERE sstatusx='1' ORDER BY smenu_id ASC")->result();
                ...
                create_menu($pmenus,$menusbb,$menusbbx,$kelas);
            }
            function create_menu($pmenus,$menusbb,$menusbbx,$kelas){
                $out = "";
                for ($i=0; $i < count($pmenus) ; $i++) { 
                    if ( is_array ( $pmenus [ $i ] ) ) {
                        if($kelas==$pmenus[$i]['kelas']){
